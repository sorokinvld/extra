...
export default function Trip({ trip, events, params }: any) {
  ...
  return (
    <>
      <Head>
        <title>{trip.title_en}</title>
        <meta
          name="description"
          content={trip.title_en + " trip page. " + trip.desc_en}
        />
      ...
      >
        <div className={styles.bannerwrapper}>
          ...
          {locale == "en" && (
            <h1 className={robotoBold.className}>{trip.title_en}</h1>
          )}
          {locale == "fr" && (
            <h1 className={robotoBold.className}>{trip.title_fr}</h1>
          )}
          {locale == "ar" && (
            <h1 className={robotoBold.className}>{trip.title_ar}</h1>
          )}
        </div>
        <main className={styles.container} id="parent">
          <div className={styles.header}>
            <h2 className={robotoBold.className}>
              {trip.nbrofplaces} {t("places")}
            </h2>
            {locale == "en" && <p className={lora.className}>{trip.desc_en}</p>}
            {locale == "fr" && <p className={lora.className}>{trip.desc_fr}</p>}
